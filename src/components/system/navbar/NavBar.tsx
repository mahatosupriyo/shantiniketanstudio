...
export default function NavBar() {
    // State to track which button the background should sit behind.
    // 0 = Products, 1 = Courses (Defaulting to 1 based on your reference image)
    ...
    return (
        <nav className={styles.navbar}>
            ...
            >
                <div>
                    <Link href="/" className={styles.element} style={{ mixBlendMode: 'difference' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="26" viewBox="0 0 62 59" fill="#352E24">
                ...
                <div className={styles.navbtnlist} onMouseLeave={() => setActiveIndex(1)}>
                    ...
                    {/* Link 1 */}
                    <Link
                        className={`${styles.btn} ${activeIndex === 0 ? styles.activeText : ''}`}
                        href="/"
                    ...
                    {/* Link 2 */}
                    <Link
                        className={`${styles.btn} ${activeIndex === 1 ? styles.activeText : ''}`}
                        href="/catalogue"
